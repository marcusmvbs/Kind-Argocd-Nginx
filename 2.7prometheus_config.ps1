...
$service_account    = "kubectl apply -f kind/kubernetes/prometheus/templates/serviceaccount.yaml"
$additional_conf    = "kubectl apply -f kind/kubernetes/prometheus/templates/secret.yaml"
$kubectl_prom_oper  = "kubectl apply -f kind/kubernetes/prometheus/templates/prometheus.yaml"
$grafana_np_svc     = "kubectl apply -f kind/kubernetes/prometheus/templates/grafana-service.yaml"
$kubectl_delete_fix = "kubectl delete service/prometheus-operated -n monitoring"
$prometheus_np_svc  = "kubectl apply -f kind/kubernetes/prometheus/templates/prometheus-service.yaml"
$apply_deploy       = "kubectl apply -f kind/kubernetes/exporter/templates/deployment.yaml"
$apply_service      = "kubectl apply -f kind/kubernetes/exporter/templates/service.yaml"
